...
-- AddForeignKey
ALTER TABLE `VERIFICATION_INFO` ADD CONSTRAINT `VERIFICATION_INFO_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `PROJECT_OWNER`(`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `PROJECT` ADD CONSTRAINT `PROJECT_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `PROJECT_OWNER`(`user_id`) ON DELETE RESTRICT ON UPDATE CASCADE;
